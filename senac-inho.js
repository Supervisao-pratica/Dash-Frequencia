(function () {
    ...
    const assistantStyleUrl = new URL("./senac-inho.css?v=1.5.2", ownScriptUrl || window.location.href).href;
    ...
    const topics = [
        ...
        t("update-call", "access", "refresh", "Atualizar a chamada da turma", "Substitua somente os dados variáveis pela versão mais recente da planilha.", "atualizar chamada reler planilha mudou mudança frequência arquivo rede substituir", [
            ...
            s("Clique em Atualizar chamada", "Esse botão abre a seleção do arquivo que será relido para a turma atual.", { text: "Atualizar chamada", tags: ["label", "button"] }, "Barra de ações"),
            s("Selecione a versão atual", "Escolha a mesma planilha da rede, já com as mudanças do dia. Contatos, justificativas e cadernos permanecem salvos.", { text: "Atualizar chamada", tags: ["label"] }, "Barra de ações"),
        ...
        ], "Nunca escolha uma planilha de outra turma ao usar a atualização."),
    ...
    function attachAssistantToChildWindow(childWindow) {
        ...
        const attachmentTimer = window.setInterval(() => {
            ...
            try {
                ...
                script.src = ownScriptUrl || new URL("./senac-inho.js?v=1.5.2", window.location.href).href;
